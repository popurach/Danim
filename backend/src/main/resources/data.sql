insert into user(nickname,client_id,profile_image_url,password)
values
('송지율','2725446611','http://k.kakaocdn.net/dn/dIUOxh/btrOfbMpO9p/JikTtvK5PtI5Wi6RMyPkDK/img_640x640.jpg','{bcrypt}$2a$10$/Gb020QJB.9SfcUPycuLpunrWYJJ/UN77XGeeUSiMxfr6amZWh2QG'),
('김지나','111111','http//www.','ww'),
('이호준','222222','http//www.','ww'),
('정우진','2725397433','http://k.kakaocdn.net/dn/dpk9l1/btqmGhA2lKL/Oz0wDuJn1YV2DIn92f6DVK/img_640x640.jpg','{bcrypt}$2a$10$LBsFE6fKaegvaFYSSvjshOVwzuVMBd40/1B2NkKrYbwzHCp4cFzCG');
