                                                    ...
                                                    MaterialPageRoute(
                                                        builder: (context) =>
                                                            ChangeNotifierProvider<UserTimelineListViewModel>(
                                                              create: (_) => UserTimelineListViewModel(context: context, myInfo: appViewModel.userInfo, userInfo: viewModel.searchedResults[index-1]),
                                                ...
                                                leading: SizedBox(
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: CachedNetworkImage(
                                                      fit: BoxFit.cover,
                                                      imageUrl: viewModel.searchedResults[index-1].profileImageUrl),
                                                  ),
                                                ),
