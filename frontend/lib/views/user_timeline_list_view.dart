    ...
    return Scaffold(
      body: Container(
        ...
        child: Consumer<TimelineListViewModel>(
          builder: (context, timelineViewModel, child) => LayoutBuilder(
                  ...
                  GestureDetector(
                    onTap: () {
                      final searchBarViewModel =
                          Provider.of<SearchBarViewModel>(context,
                              listen: false);
                              ...
                              children: [
                                Expanded(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl:
                                          timelineViewModel.profileImageUrl!,
                                    )),
                                const Expanded(
                                    flex: 1,
                                    child:
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(timelineViewModel.nickname!),
                                      Column(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceEvenly,
                                        children: [
                    ...
                    child: Container(
                      ...
                      child: ChangeNotifierProvider<SearchBarViewModel>(
                        create: (_) => SearchBarViewModel(
                            userUid: timelineViewModel.userUid),
                        child: SearchBar(),
                      ),
                    ),
                  ),
