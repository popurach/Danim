                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      ChangeNotifierProvider(
                                          create: (_) => UserTimelineListViewModel(context: context, myInfo: appViewModel.userInfo, userInfo: userTimelineListViewModel.userInfo),
                                          child: UserInformationView(),),
                                      // 타임라인 리스트가 들어가는 칸
                                      Expanded(
                                          child: ChangeNotifierProvider(
                                            create: (_) => TimelineListViewModel(context: context, userUid: userTimelineListViewModel.userInfo.userUid, myUid: appViewModel.userInfo.userUid ),
                              ...
                              Positioned(
                                top: constraints.maxHeight * 0.8,
                                  ...
                                  child: GestureDetector(
                                    onTap: () {appViewModel.startTravel();},
                                    child: Container(
